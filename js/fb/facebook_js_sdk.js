...
FB.provide('', {
  ...
  init: function(options) {
    ...
    if (FB._nativeInterface) {
      FB._nativeInterface.init(FB._apiKey, function(e) {window.console.log('PhoneGap Facebook Connect plugin fail on init!');});
    }
  ...
  ui: function(params, cb) {
    ...
    if (FB._nativeInterface) {
        switch (params.method) {
            case 'auth.login':
                FB._nativeInterface.login(params, cb, function(e) {window.console.log('PhoneGap Facebook Connect plugin fail on login!' + e);});
                break;
            case 'auth.logout':
                FB._nativeInterface.logout(cb, function(e) {window.console.log('PhoneGap Facebook Connect plugin fail on logout!');});
                break;
            case 'auth.status':
                FB._nativeInterface.getLoginStatus(cb, function(e) {window.console.log('PhoneGap Facebook Connect plugin fail on auth.status!');});
                break;
        }
        return;
    }
